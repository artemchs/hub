...
import { goodsInternalFieldsColumns } from "../admin/internal-fields/_components/table/columns";
...
export const useGoodsInternalFieldsTable = createTableStore(
  "goods-internal-fields",
  goodsInternalFieldsColumns
);
