                        ...
                        <Group>
                            <ActionIcon
                                ...
                                onClick={() =>
                                    form.setFieldValue(
                                        "schema.attributes",
                                        form.values.schema.attributes?.filter(
                                            (_, i) => i !== index
                                        )
                                    )
                                }
                        ...
                        <Group>
                            ...
                            <Stack className="flex-1 flex-col">
                                <GoodsCharacteristicCombobox
                                    ...
                                    setId={(id) =>
                                        form.setFieldValue(
                                            `schema.characteristics.${index}.id`,
                                            id
                                        )
                                    }
                                />
                        ...
                        <Group>
                            ...
                            <Stack className="flex-1 flex-col">
                                <GoodsInternalFieldCombobox
                                    ...
                                    setId={(id) =>
                                        form.setFieldValue(
                                            `schema.internalFields.${index}.id`,
                                            id
                                        )
                                    }
                                />
