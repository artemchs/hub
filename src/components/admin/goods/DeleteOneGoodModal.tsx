...
export function DeleteOneGoodModal({
  id,
  opened,
  close,
}: {
  ...
  const { mutate, isPending } = api.goods.deleteOne.useMutation({
    async onSuccess() {
  ...
  return (
    <Modal opened={opened} onClose={close} title="Удалить товар">
      <Text>Вы уверены что хотите удалить этот товар?</Text>
